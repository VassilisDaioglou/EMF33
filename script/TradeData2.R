...
# Read Data File
TradDATA=read.csv(paste0(getwd(),"/data/Trade/TradDATA.csv"), sep=",", dec=".", stringsAsFactors = FALSE)
TradPrice=read.csv(paste0(getwd(),"/data/Trade/TradPrice.csv"), sep=",", dec=".", stringsAsFactors = FALSE)
...
write.csv(NewReg, file = paste0(getwd(),"/data/Trade/TradeRegData.csv"))
...
write.csv(PriceAllR1, file = paste0(getwd(),"/data/Trade/TradeRegPrice.csv"))
